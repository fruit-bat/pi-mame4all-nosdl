...
static void gles2_DrawQuad_32(const ShaderInfo *sh, GLuint p_textures[2])
{
...
printf("-");
	...
	glTexSubImage2D(GL_TEXTURE_2D, 0, 0, 0, width, height, GL_RGB, GL_UNSIGNED_INT, (unsigned short*) screen); SHOW_ERROR
	gles2_DrawQuad_32(&shader, textures);
