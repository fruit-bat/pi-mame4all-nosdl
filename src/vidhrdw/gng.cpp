...
int gng_vh_start(void)
{
	...
	bg_tilemap->transmask[0] = 0x00; /* split type 0 is totally NOT transparent in front half */
	bg_tilemap->transmask[1] = 0xe0; /* split type 1 has pen 1 transparent in front half */
  //bg_tilemap->transparent_pen = 3;
	return 0;
}
